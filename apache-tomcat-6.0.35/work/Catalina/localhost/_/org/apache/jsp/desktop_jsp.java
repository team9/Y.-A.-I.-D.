...
public final class desktop_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    System.out.println("The wallpath is :" + objreturn.wallpaper_path);
      ...
      out.write("        <script src=\"JQUERY/jquery.jscroll.min.js\" type=\"text/javascript\"></script>\r\n");
      out.write("        <script src=\"JQUERY/fileupload/jquery.fileupload.js\" type=\"text/javascript\"></script>\r\n");
      out.write("        <script src=\"JQUERY/fileupload/jquery.fileupload-ui.js\" type=\"text/javascript\"></script>\r\n");
      out.write("        <script src=\"JQUERY/jquery.flash.js\" type=\"text/javascript\"></script>\r\n");
      out.write("        <script src=\"JQUERY/flarevideo.js\" type=\"text/javascript\"></script> \r\n");
      out.write("\r\n");
      ...
      out.write("        <!--        <script src=\"http://github.com/malsup/media/raw/master/jquery.media.js?v0.92\"></script>-->\r\n");
      ...
      out.write("        <link rel=\"stylesheet\" href=\"CSS/flarevideo.css\" type=\"text/css\" />\r\n");
      out.write("        <link rel=\"stylesheet\" href=\"CSS/flarevideo.default.css\" type=\"text/css\" />\r\n");
      out.write("        <link href=\"CSS/Calculator/Calculator.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n");
      out.write("\r\n");
      out.write("        <style>\r\n");
      out.write("            body{ \r\n");
      ...
      out.write("                \r\n");
      out.write("                var userSpaceLimit = 2*1024;\r\n");
      out.write("                var parameters= {\r\n");
      out.write("                    \"targetid\": \"85\",\r\n");
      out.write("                    \"operation\" : \"getUsersSpaceUsage\"\r\n");
      out.write("                };\r\n");
      out.write("                $.ajax({\r\n");
      out.write("                    type:'POST',\r\n");
      out.write("                    url:\"SpaceUsage\", //calling servlet\r\n");
      out.write("                    cache:false,\r\n");
      out.write("                    data:parameters,\r\n");
      out.write("                    success:function(htmldat){\r\n");
      out.write("                        var userOccupiedSpace = Math.round(htmldat/(1024*1024)*100)/100;\r\n");
      out.write("                        $(\"#spaceUsageValue\").html(userOccupiedSpace + \"MB / \" + userSpaceLimit + \"MB (\" + Math.round(userOccupiedSpace/userSpaceLimit*100*1)/1 +\"%)\");\r\n");
      out.write("                        $(\"#spaceUsageGraph\").progressbar({value:((Math.round(htmldat/(1024*1024)))/userSpaceLimit*100 *1)/1}); \r\n");
      out.write("                        \r\n");
      out.write("                    },\r\n");
      ...
      out.write("                \r\n");
      out.write("                var clock = \"");
      out.print(objreturn.clock_set);
      out.write("\";\r\n");
      out.write("                var calender = \"");
      out.print( objreturn.calender_set);
      out.write("\";\r\n");
      out.write("\r\n");
      out.write("                if(clock == \"hide\") {\r\n");
      out.write("                    $('#analog-clock').hide();\r\n");
      out.write("                }else if(clock == \"show\") {\r\n");
      out.write("                    $('#analog-clock').show();\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                if(calender == \"hide\") {\r\n");
      out.write("                    $('#datepicker').hide();\r\n");
      out.write("                } else if(calender == \"show\") {\r\n");
      out.write("                    $('#datepicker').show();\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      ...
      out.write("               new Explorer(\"/\");\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            function openSpaceUsage() {\r\n");
      out.write("                Window({'option':{'title':'Space Usage',height:100, width:500},'content':'userSpaceUsage.jsp',\"ajax\":true}).draggable();\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      ...
      out.write("                    'title':'Calculator',\r\n");
      out.write("                     resizable: false,\r\n");
      out.write("                    height:410,\r\n");
      out.write("                    width:390\r\n");
      out.write("                },\r\n");
      out.write("                'content':'Calculator.htm',\r\n");
      out.write("                \"ajax\":true}).draggable();\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      ...
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            function openWallpapers() {\r\n");
      out.write("                WallpaperMan();\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      ...
      out.write("            </div>\r\n");
      out.write("\r\n");
      out.write("            <div class =\"context-menu-calendar box menu-1\" id=\"datepicker\" style=\"width: 50px; position: fixed; left:700px; top:300px;\"></div>\r\n");
      out.write("\r\n");
      out.write("            <div id=\"startmenu\" >\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("                <div class=\"wrapper\">\r\n");
      out.write("                    <div id=\"startMenuHeader\" ><strong>Start Off !</strong></div>\r\n");
      ...
      out.write("                            <tr><td class=\"rootVoice {menu: 'empty'}\"  onclick=\"openFileBrowser()\">Home</td></tr>\r\n");
      out.write("                            <tr><td class=\"rootVoice {menu: 'empty'}\" onclick=\"openSpaceUsage()\">Space Usage</td></tr>\r\n");
      out.write("                            <tr><td class=\"rootVoice {menu: 'empty'}\"  onclick=\"openWallpapers()\">Wallpapers</td></tr>\r\n");
      out.write("\r\n");
      out.write("                        </table>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                            <tr><td class=\"rootVoice {menu: 'empty'}\" onclick=\"openCalculator()\">Calculator</td></tr>\r\n");
      out.write("                            <tr><td class=\"rootVoice {menu: 'empty'}\"  onclick=\"openWidgetManager()\">Widget Manager</td></tr>\r\n");
      out.write("\r\n");
      out.write("                        </table>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                                <input type=\"submit\" value=\"\" class=\"submit\" size=\"70px;\"/> \r\n");
      out.write("                            </form>\r\n");
      out.write("                        </div>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                        <a rel=\"title\" class=\"{menu:'', img: '../images/icons/applications.png'}\">Applications</a>\r\n");
      out.write("                        <a class=\"{menu:'', img: '../images/icons/calculator.png'}\"  onclick=\"openCalculator()\">Calculator</a>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("                        <a class=\"{menu:'', img: '../images/icons/video.png'}\">Video Player</a>\r\n");
      out.write("                        <a class=\"{menu:'', img: '../images/icons/audio.png'}\">Audio Player</a>\r\n");
      out.write("                    </div>-->\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("            <div id=\"dialog_window_minimized_container\" class=\"ui-widget-header ui-corner-all\" style=\"float: left; height: 35px; font-weight: thick;\" onclick=\"return hideStartMenu()\">\r\n");
      out.write("\r\n");
      out.write("                <div id=\"spaceDetails\"  style=\"padding-top:  10px; border-left: double black; float: right; padding-left:  10px; height: 25px; \">\r\n");
      out.write("                    <div id=\"spaceUsageGraph\" style=\"width: 300px; float: right; border: double black; height: 10px; \">\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div id=\"spaceUsageValue\" style=\"width: 150px; float: right;\">\r\n");
      out.write("\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div id=\"spaceUsageText\" style=\"width: 110px; float: right;\">\r\n");
      out.write("                        User Space Usage :\r\n");
      out.write("                    </div></div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("    </body>\r\n");
