...
<%
    ...
    //String userserial = (String)session.getAttribute("userSerial");
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function openSpaceUsage() {
                Window({'option':{'title':'Space Usage',height:400, width:350},'content':'userSpaceUsage.jsp',"ajax":true}).draggable();
            }
