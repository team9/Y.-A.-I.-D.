...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'JS/TextEditor/nicEditorIcons.gif',
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','image','upload','link','unlink','forecolor','bgcolor'],
	iconList : {"bgcolor":1,"forecolor":2,"bold":3,"center":4,"hr":5,"indent":6,"italic":7,"justify":8,"left":9,"ol":10,"outdent":11,"removeformat":12,"right":13,"save":22,"strikethrough":15,"subscript":16,"superscript":17,"ul":18,"underline":19,"image":20,"close":21,"arrow":23,"upload":24}
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	addForm : function() {
		...
		if(this.uri == this.nicURI) {
			myDoc.write('<div style="position: absolute; margin-left: 160px;"><div style="float: left; margin-left: 5px; font-size: 10px;"><br /><a href="http://www.imageshack.us/" target="_blank"></a></div></div>');
		}
